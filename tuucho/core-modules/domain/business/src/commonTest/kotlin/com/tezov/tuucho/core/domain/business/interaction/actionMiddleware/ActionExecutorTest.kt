...
//        val actionModel = ActionModel.from(actionString)
//
//        val actionObject = buildJsonObject {
...
//                        context.input.actionModel == actionModel &&
//                        context.lockable is InteractionLockable.Empty
//                }
//            )
//            interactionLockResolver.release(any(), InteractionLockable.Empty)
...
//
//        val actionModelFirst = ActionModel.from(actionStringFirst)
//        val actionModelSecond = ActionModel.from(actionStringSecond)
//
//        val actionObject = buildJsonObject {
//            put(
//                "primaries",
