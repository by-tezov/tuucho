...
import com.tezov.tuucho.core.domain.model.material.ContentModelDomain
...
class ContentModelDomainDecoder(
    ...
    override suspend fun decode(
        ...
        .resolveRefs(config.url, ContentModelDomain.Default.type, database)
        .map {
