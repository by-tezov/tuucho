...
class PageDJsonResource : JsonResourceProtocol {

    override val url = "page-d"
    ...
    override val jsonString = """
{
  ...
  "root": {
    ...
    "style": {
      ...
      "background-color": "*background:aqua-splash",
      "fill-max-size": true
    },
    "content": {
      "items": [
        "*item-spacer",
        {
          ...
          "style": "*title-label",
          "content": {
            "value": "Page-D - with not solid background"
          }
        },
        "*item-spacer",
        {
