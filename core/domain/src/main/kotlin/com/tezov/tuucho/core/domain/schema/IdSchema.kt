...
interface IdSchema {
    ...
    companion object {
        ...
        val JsonElement.idRawOrNull get() = this.jsonObject[Key.id]
        ...
        val JsonElement.idValueOrNull get() = this.jsonObject[Key.Id.value].stringOrNull

        val JsonElement.idSource get() = this.jsonObject[Key.Id.source].string
        val JsonElement.idSourceOrNull get() = this.jsonObject[Key.Id.source].stringOrNull

        val JsonElement.isIdAutoGenerated get() = this.jsonObject[Key.Id.id_auto_generated].booleanOrNull == true
