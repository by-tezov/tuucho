...
import com.tezov.tuucho.core.domain.business.usecase.GeyValueFromStoreUseCase.Input

class GeyValueFromStoreUseCase(
    private val coroutineScopes: CoroutineScopesProtocol,
    private val keyValueRepository: KeyValueStoreRepositoryProtocol,
) : UseCaseProtocol.Async<Input, GeyValueFromStoreUseCase.Output> {
