...
class InterractionLockRepository(
    ...
    override suspend fun tryLock(type: InterractionLockRepositoryProtocol.Type): String? {
    ...
    override suspend fun unLock(type: InterractionLockRepositoryProtocol.Type, handle: String) {
        mutex.withLock {
